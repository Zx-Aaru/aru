...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Zx-Aaru/Khargosh",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/khargosh_updates")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/lifeunfilter")
